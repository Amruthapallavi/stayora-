...
const Properties = () => {
  ...
  return (
    <div className="p-4 md:p-8 lg:ml-64 min-h-screen">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            ...
            <Link 
              ...
              className="bg-golden text-white px-4 py-2 rounded-md shadow-md hover:bg-golden-dark transition inline-flex items-center justify-center"
            >
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <Link 
              to="/owner/add-property"
              className="bg-golden text-white px-6 py-3 rounded-md shadow-md hover:bg-golden-dark transition inline-flex items-center justify-center"
            >
              <Plus size={18} className="mr-2" />
