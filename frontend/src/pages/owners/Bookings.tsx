...
import { Calendar, Clock, User, Home, DollarSign, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
              ...
              {filteredBookings.map((booking) => (
                <Card key={booking._id} className="p-4 bg-white">
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    ...
                    <div className="flex flex-col items-end">
                      <div className="flex items-center mb-2">
                        <DollarSign className="h-5 w-5 text-[#059669] mr-1" />
                  ...
                  <div className="border-t mt-4 pt-4 flex justify-end space-x-3">
                    <button className="text-[#4b5563] hover:text-[#111827] text-sm font-medium">
                      View Details
                    </button>
                    {booking.bookingStatus === 'pending' && (
                      <>
                        <button className="text-[#059669] hover:text-[#047857] text-sm font-medium flex items-center">
                          <CheckCircle className="h-4 w-4 mr-1" /> Confirm
                        </button>
                        <button className="text-[#dc2626] hover:text-[#b91c1c] text-sm font-medium flex items-center">
