...
import { ArrowLeft, Edit, MapPin, BedDouble, Bath, Building, Home, Calendar, DollarSign, Trash2, Share2 } from 'lucide-react';
...
const handleDeleteProperty = async (propertyId: string) => {
  try {
    ...
    if (res) {
      ...
      notifyError(res?.message || "Failed to delete property");
    }
  } catch (error) {
              ...
              <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
                ...
                <DialogContent>
                  ...
                  <DialogFooter>
                    ...
                    <Button variant="destructive" onClick={() => handleDeleteProperty(property._id)}>
                    Delete Property
                    </Button>
                  </DialogFooter>
                </DialogContent>
