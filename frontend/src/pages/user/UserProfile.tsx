...
import { User, Key, Mail, Phone, MapPin, Calendar, CloudDownload } from 'lucide-react';
...
const Profile = () => {
              ...
              <CardContent className="p-6">
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-full space-y-2">
                    ...
                    <div className="flex items-center gap-3 text-gray-600">
                      <MapPin size={18} />
                      <span>{userData?.address?.city}, {userData?.address?.district}, {userData?.address?.state} , {userData?.address?.pincode}</span>
                    </div>
                    <div className="flex items-center gap-3 text-gray-600">
                      <Calendar size={18} />
  ...
  <p className="text-sm text-gray-500">
    Joined on: {moment.default(userData.createdAt).format("D MMM YYYY")
    }
  </p>
)}
                    </div>
