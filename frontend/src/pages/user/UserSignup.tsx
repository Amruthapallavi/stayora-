    ...
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center">
      <div className="flex flex-col md:flex-row w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://static.vecteezy.com/system/resources/previews/026/586/056/non_2x/beautiful-modern-house-exterior-with-carport-modern-residential-district-and-minimalist-building-concept-by-ai-generated-free-photo.jpg')",
            backgroundSize: "cover",
            backgroundPosition: "center",
            backgroundRepeat: "no-repeat",
          }}
        >
          <h2 className="text-white text-2xl font-extrabold tracking-wider">
            USER SIGNUP
          </h2>
        </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className="w-full mt-2 p-2 border rounded-lg focus:outline-none focus:ring-4 focus:ring-[#a0815c] transition duration-300"
                required
              />
            </div>
