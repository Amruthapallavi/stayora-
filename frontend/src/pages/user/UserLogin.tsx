  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden">
        {/* Left Panel */}
        <div
          className="md:w-1/3 bg-[#a0815c] flex items-center justify-center p-10"
          style={{
            backgroundImage:
              "url('https://e0.pxfuel.com/wallpapers/673/923/desktop-wallpaper-high-resolution-nature-brown-nature.jpg')",
          }}
        >
