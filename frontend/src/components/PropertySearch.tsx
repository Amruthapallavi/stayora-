      ...
      <div className="p-6">
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <div className="flex gap-2 w-full md:w-auto">
            <Button 
              variant="outline" 
              className="border-[#b68f5a] text-[#b68f5a] hover:bg-[#d3ae7a] hover:text-white flex-grow md:flex-grow-0"
            ...
            <Button 
              className="bg-[#b68451] hover:bg-[#d3ae7a] flex-grow md:flex-grow-0 text-white"
        ...
        {showFilters && (
          <motion.div 
            className="mt-6 pt-6 border-t border-[#d3ae7a]"
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className="bg-gray-50 border-[#b68f5a] rounded-lg">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className="bg-[#fffff] border-[#b68f5a] rounded-lg">
